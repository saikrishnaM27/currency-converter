...
const Converter = () => {
    ...
    return (
        ...
        <div className="converterApp w-50 m-auto border p-4 bg-white">
            ...
            <div className="convert ">
                <button className="btn btn-primary w-50" onClick={handleConvert}>Convert</button>
            </div>
            <div className="outputField px-4 mt-4 border py-2">
                <h3 className="">Converted Amount is:</h3>
                <h3 className="px-4 mt-4 text-success">{convAmt}</h3>
            </div>
        </div >
    )
}
